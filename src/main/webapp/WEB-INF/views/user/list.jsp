...
<!-- datepicker-->
<link href="${URL}bootstrap/css/datepicker.css" rel="stylesheet"
	rel="stylesheet" type="text/css" />
</head>
<body class="skin-blue sidebar-mini">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<table id="dt_lstUser" class="table table-bordered table-hover">
									<thead>
										<tr>
											<th>User name</th>
											<th>Email</th>
	...
	<script src="${URL}bootstrap/js/bootstrap-datepicker.js"
		type="text/javascript"></script>
	<!-- end load jQuey of datepicker -->
	<!-- page script -->
	<script src="${URL}js/erp_user.js" type="text/javascript"></script>
</body>
</html>
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		<!-- form start -->
		<form role="form" class="form-horizontal" action="./submitSupplier.do" id="formSupplier"
			method="POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Enter name" id="txtName"
												name="txtName" value="${SUPPLIER.name}" 
												class="form-control">
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Fax" id="txtFax"
												name="txtFax" value="${SUPPLIER.fax}" 
												class="form-control">
										</div>
									</div>
									<div class="form-group">
			...
			<div class="modal-footer">
				<input type="hidden" value="true" name="isUpdate" /> <input
					type="hidden" value="${SUPPLIER.id}" name="uuid" />

...
<%
	AccountTax accountTax = (AccountTax) request
			.getAttribute("ACCOUNTTAX");
%>
		...
		<form role="form" class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" name="name"
											id="txtName" value="${ACCOUNTTAX.name}" placeholder="Name"
											readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" id="txtAmount"
											name="amount" value="${ACCOUNTTAX.amount}"
											placeholder="Amount">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea class="form-control" id="txtDescription"
											name="description" text="${ACCOUNTTAX.description}"
			...
			<div class="modal-footer">
				<input type="hidden" value="true" name="isUpdate" /> <input
					type="hidden" value="${ACCOUNTTAX.id}" name="uuid" />
